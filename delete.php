...
if (isset($_GET['id'])) {
  ...
  if ($q) {
    ...
    echo "<script>alert('Data berhasil dihapus'); window.location.href='tokobuku.php'</script>";
  } else {
    // pesan apabila hapus gagal
    echo "<script>alert('Data gagal dihapus'); window.location.href='tokobuku.php'</script>";
  }
} else {
