      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active ">
            <a class="nav-link" href="tokobuku.php">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="harga_buku" placeholder="HARGA BUKU">       
        </div>            
        <div class="form-group col-md-6">
          <label for="">STOK BUKU</label>
          <input type="text" class="form-control" name="stok_buku" placeholder="STOK BUKU">
        </div>               																		
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
						include 'koneksi.php';
						$stid = oci_parse($koneksi, 'SELECT * from toko_buku');
						oci_execute($stid);
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $d['HARGA_BUKU']; ?>
                          </td>
                          <td>
                            <?php echo $d['STOK_BUKU']; ?>
                          </td>
                          <td class="td-actions">
						  <a href="update.php?id=<?= $d['ID_BUKU'] ?>">
